...
Self	Processing time of this function itself. The processing time of subfunctions is not included. (displayed in %) Self
...
-------------------- 
GC	The amount of memory used in the heap area, which is increased by GC Alloc and other factors.
...
Others	Assignments to objects other than those listed above that Unity uses in various systems.
//}
...
Depth Slice	This is the number of slice in the Hierarchy view introduced in CPU Usage. @<br>{} For example, if Depth is 3, the third level of the hierarchy is displayed.
Analysis Type	This allows you to switch between Total and Self, which was included in the CPU Usage header item.
